  ...
  shinydashboard::dashboardPage(
    ...
    shinydashboard::dashboardSidebar(
      ...
      shinydashboard::sidebarMenu(
        ...
        shinydashboard::menuItem("CalVals",
          tabName = "", icon = shiny::icon("flask", lib = "font-awesome"),
          startExpanded = FALSE,
          collapsible =
        ...
        shinydashboard::menuItem("Eddy QFQM ",
          tabName = "", icon = shiny::icon("flask", lib = "font-awesome"),
          startExpanded = FALSE,
          collapsible =
            shinydashboard::menuSubItem(text = "", tabName = ""), # I have no idea why, but this first one never appears on the ui?
        ...
        shinydashboard::menuItem("TIS OS Data",
          tabName = "", icon = shiny::icon("circle-notch", lib = "font-awesome"),
          startExpanded = FALSE,
          collapsible =
            shinydashboard::menuSubItem(text = "", tabName = ""), # I have no idea why, but this first one never appears on the ui?
    ...
    shinydashboard::dashboardBody(
      ...
      shinydashboard::tabItems(
        ...
        shinydashboard::tabItem(
          tabName = "swft_lcservices_tab",
          shinydashboard::box(
            width = 12,
            shiny::column(
              width = 3,
              shiny::selectizeInput(
                inputId = "swft_lcservices_site", label = "Select SiteID", multiple = FALSE,
                choices = as.vector(swft.full.site.lookup$SiteID),
                selected = "HARV",
                width = "100%"
              ),
              shiny::dateRangeInput(
                inputId = "swft_lcservices_date_range", label = "Select Date Range for Plot [dev]",
                start = Sys.Date() - 8, end = Sys.Date() + 2
              ),
              shiny::selectizeInput(
                inputId = "swft_lcservices_lc_number", label = "Select LC Number", multiple = FALSE,
                choices = c(1, 2)
              ),
            ...
            shiny::column(
              ...
              shiny::fluidRow(
                ...
                shiny::conditionalPanel(
                  condition = "input.swft_lcservices_radio_lcnumber == 'hornetq'",
                  shiny::conditionalPanel(
                    condition = "input.swft_lcservices_radio_overall == 1",
          ...
          shinydashboard::box(
            ...
            shiny::fluidRow(
              shiny::column(
                width = 2,
                shiny::selectizeInput(
                  inputId = "swft_spangas_site", label = "Select SiteID", multiple = FALSE,
              ...
              shiny::column(
                width = 3,
                shiny::dateRangeInput(
                  inputId = "swft_spangas_date_range", label = "Select Date Range for Plot",
            ...
            shinydashboard::tabBox(
              ...
              shiny::tabPanel("Delivery Pressure",
                width = 12,
              ...
              shiny::tabPanel("Avg Pressure Loss",
                width = 12,
              ...
              shiny::fluidRow(
                shiny::column(
                  ...
                  shiny::column(
                    ...
                    shiny::fluidRow(
                      shiny::selectizeInput(
                        inputId = "swft_cval_site", multiple = FALSE,
                        label = "Select Site",
                        choices = swft.tis.site.lookup$SiteID,
                        selected = sample(swft.tis.site.lookup$SiteID, 1)
                      ),
                      shiny::selectizeInput(
                        inputId = "swft_cval_sensor", multiple = FALSE,
                  ...
                  shiny::column(
                    ...
                    shiny::conditionalPanel(
                      condition = "input.swft_cval_sensor == 'L2130i'",
              ...
              shiny::tabPanel("",
                ...
                shiny::fluidRow(
                  shiny::column(
                    ...
                    # Co2 Analyzers Data
                    shiny::conditionalPanel(
                      condition = 'input.swft_cval_sensor == "Li840A"',
                      shiny::fluidRow(
                    ...
                    shiny::conditionalPanel(
                      condition = 'input.swft_cval_sensor == "G2131i"',
                      shiny::fluidRow(
                    ...
                    shiny::conditionalPanel(
                      condition = 'input.swft_cval_sensor == "Li7200"',
                      shiny::fluidRow(
        ...
        shinydashboard::tabItem(
          tabName = "swft_historic_span_table_tab",
          shinydashboard::box(
            width = 12,
            shiny::column(
              width = 12,
              ...
              shiny::tabPanel("",
                ...
                shiny::fluidRow(
                  shiny::column(
                    width = 12,
                    shiny::tags$a(
                      shinydashboard::valueBoxOutput("swft_ec_fast_ml_missing", width = 2),
                      title = "An algorithm calculated for each site if each ML flow was above 2.0 SLPM, if this was the case, it was considered valid."
                    ),
                    shiny::tags$a(
                      shinydashboard::valueBoxOutput("swft_ec_fast_li840_working", width = 2),
                      title = "An algorithm calculated for each site if the sample MFC flow was within 0.8 and 1.2 SLPM and the CO2 values were between 200 and 1000."
                    ),
                    shiny::tags$a(
                      shinydashboard::valueBoxOutput("swft_ec_fast_g2131_working", width = 2),
                      title = "An algorithm calculated for each site if the CO2 values were between 200 and 1,000."
                    ),
                    shiny::tags$a(
                      shinydashboard::valueBoxOutput("swft_ec_fast_l2130_working", width = 2),
                      title = "An algorithm calculated for each site if the H2O values were between 0 and 50,000."
                    ),
                    shiny::tags$a(
                      shinydashboard::valueBoxOutput("swft_ec_fast_li7200_working", width = 2),
                      title = "An algorithm calculated for each site if the CO2 values were between 0 and 1,000, the diagnostic was between 8188 and 8191, the MFC flow was between 10.0 and 14.0 SLPM, and the differential cell temperature was between 2.0C and 6.0C."
                    ),
                    shiny::tags$a(
                      shinydashboard::valueBoxOutput("swft_ec_fast_collect_data_time", width = 2),
                      title = "Calculates how long it took to pull all the files and produce the plot."
                    )
                  )
                ),
                shiny::br(),
                ...
                shiny::fluidRow(
                  shiny::column(
                    ...
                    shiny::fluidRow(
                      shiny::dateRangeInput(
                        inputId = "swft_EddyCo_date_range", label = "Select a Date Range",
                        min = "2017-01-01",
                        start = Sys.Date() - 7,
                        end = Sys.Date()
                      )
                  ...
                  shiny::column(
                    ...
                    shiny::fluidRow(
                      shiny::selectizeInput(
                        inputId = "swft_EddyCo_site", multiple = FALSE,
                        label = "Select Site",
                  ...
                  shiny::column(
                    ...
                    shiny::fluidRow(
                      shiny::selectizeInput(
                        ...
                        label = "Select Data",
                        choice = c(
                          "ECSE Iso Analyzer - G2131i" = "G2131",
                  ...
                  shiny::column(
                    ...
                    shiny::fluidRow(
                      shiny::conditionalPanel(
                        condition = "input.swft_EddyCo_data_type == 'G2131'",
                      ...
                      shiny::conditionalPanel(
                        condition = "input.swft_EddyCo_data_type == 'Li840'",
                      ...
                      shiny::conditionalPanel(
                        condition = "input.swft_EddyCo_data_type == 'L2130'",
                      ...
                      shiny::conditionalPanel(
                        condition = "input.swft_EddyCo_data_type == 'Li7200'",
                      ...
                      shiny::conditionalPanel(
                        condition = "input.swft_EddyCo_data_type == 'HMP155'",
                      ...
                      shiny::conditionalPanel(
                        condition = "input.swft_EddyCo_data_type == 'amrs'",
                ...
                shiny::fluidRow(
                  shiny::column(
                    ...
                    shiny::column(
                      width = 12,
                      shiny::conditionalPanel(
                        condition = "input.swft_EddyCo_radioButton == 'Enabled' ",
                        shiny::column(
                          width = 4,
                        ...
                        shiny::conditionalPanel(
                          condition = "input.swft_EddyCo_radio_y_custom == 'Yes'",
                          shiny::column(
                            width = 2,
        ...
        shinydashboard::tabItem(
          ...
          shinydashboard::box(
            ...
            shiny::column(
              ...
              shiny::conditionalPanel(
                condition = "input.swft_mntc_data_select == 'Tower'",
              ...
              shiny::conditionalPanel(
                condition = "input.swft_mntc_data_select == 'Soil'",
              ...
              shiny::conditionalPanel(
                condition = "input.swft_mntc_data_select == 'Eddy'",
              ...
              shiny::conditionalPanel(
                condition = "input.swft_mntc_data_select == 'DFIR'",
              ...
              shiny::conditionalPanel(
                condition = "input.swft_mntc_data_select == 'Comments'",
        ...
        shinydashboard::tabItem(
          tabName = "swft_obs_maintenance_tab",
          shinydashboard::box(
            width = 12,
            shiny::column(
              width = 12,
          ...
          shinydashboard::box(
            ...
            shiny::fluidRow(
              ...
              shiny::column(
                width = 2,
                shiny::selectInput(
                  inputId = "swft_qfqm_eddy4R_terms", label = "Terms",
