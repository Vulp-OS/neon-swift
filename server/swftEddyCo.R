...
swft_ec_fast_plot <- shiny::eventReactive(input$swft_ec_fast_actionButton, {
  ...
  if (input$swft_EddyCo_data_type != "CO2" & input$swft_EddyCo_data_type != "H2O") {
    ...
    swft.data.in <- read.eddy.inquiry(
      dataType = "2min",
    ...
    if (nrow(swft.data.in) > 0 & input$swft_EddyCo_data_type != "CSAT3") {
      swft.data.in <- swft.data.in %>%
        dplyr::mutate(`Stream Name` = strm_name) %>%
        dplyr::select(-strm_name)
    }
  ...
  if (nrow(swft.data.in) > 0) {
    ...
    if (input$swft_EddyCo_data_type == "G2131") {
      ...
      if (input$swft_EddyCo_sub_data_type_Li840 %in% c("CO2", "H2O")) {
        ...
        # Pull Valve Data Too
        swft.li840.valves <- read.eddy.inquiry(
          dataType = "2min",
          sensor = "Li840.valves",
          siteID = input$swft_EddyCo_site,
        ...
        # Read flow data
        swft.data.out <- read.eddy.inquiry(
          dataType = "2min",
      ...
      flow.text <- paste0(
        swft.flowRateLookup.table$SiteID[1], "'s expected flowrate based upon environmental conditions is: ",
      ...
      swft.data.out <- swft.data.in %>%
        ...
        tidyr::separate(col = `Stream Name`, into = c("ML", "Location", "useless"), sep = "_", remove = FALSE) %>%
  ...
  if (nrow(swft.data.out) > 0) {
    ...
    if (input$swft_EddyCo_data_type == "G2131") {
      if (input$swft_EddyCo_sub_data_type_G2131 == "CO2") {
        ...
        swft.plot <- ggplot(data = swft.data.out, aes(x = readout_time, y = readout_val_double, color = SampleLevel)) +
          ...
          labs(
            x = "", y = "Concentration (ppm)", title = paste0(input$swft_EddyCo_site, " - ", input$swft_EddyCo_data_type, " ", input$swft_EddyCo_sub_data_type_G2131),
            subtitle = paste0(input$swft_EddyCo_date_range[1], " to ", input$swft_EddyCo_date_range[2])
          ) +
          theme(strip.text.x = element_text(size = 14), text = element_text(color = "white", face = "bold", size = 20)) +
      ...
      if (input$swft_EddyCo_sub_data_type_G2131 == "H2O") {
        ...
        swft.plot <- ggplot(data = swft.data.out, aes(x = readout_time, y = readout_val_double, color = SampleLevel)) +
          ...
          scale_y_continuous(breaks = scales::pretty_breaks(n = 6), sec.axis = dup_axis(name = "")) +
          labs(
            x = "", y = "", title = paste0(input$swft_EddyCo_site, " - ", input$swft_EddyCo_data_type, " ", input$swft_EddyCo_sub_data_type_G2131),
            subtitle = paste0(input$swft_EddyCo_date_range[1], " to ", input$swft_EddyCo_date_range[2])
          ) +
      ...
      if (input$swft_EddyCo_sub_data_type_G2131 == "Isotopes") {
        ...
        swft.plot <- ggplot(data = swft.data.out, aes(x = readout_time, y = readout_val_double, color = SampleLevel)) +
          ...
          scale_y_continuous(breaks = scales::pretty_breaks(n = 6), sec.axis = dup_axis(name = "")) +
          labs(
            x = "", y = "Concentration", title = paste0(input$swft_EddyCo_site, " - ", input$swft_EddyCo_data_type, " ", input$swft_EddyCo_sub_data_type_G2131),
            subtitle = paste0(input$swft_EddyCo_date_range[1], " to ", input$swft_EddyCo_date_range[2])
          ) +
          theme(strip.text.x = element_text(size = 12), text = element_text(color = "white", face = "bold", size = 20)) +
          guides(colour = guide_legend(override.aes = list(size = 5, alpha = 1)))
    ...
    if (input$swft_EddyCo_data_type == "Li840") {
      if (input$swft_EddyCo_sub_data_type_Li840 == "CO2") {
        ...
        swft.plot <- ggplot(data = swft.data.out, aes(x = readout_time, y = readout_val_double, color = SampleLevel)) +
          ...
          scale_x_datetime(breaks = scales::pretty_breaks(n = 10), date_labels = "%Y-%m-%d") +
          labs(
            x = "", y = "Concentration (ppm)", title = paste0(input$swft_EddyCo_site, " - ", input$swft_EddyCo_data_type, " ", input$swft_EddyCo_sub_data_type_Li840),
            subtitle = paste0(input$swft_EddyCo_date_range[1], " to ", input$swft_EddyCo_date_range[2])
          ) +
          theme(strip.text.x = element_text(size = 12), text = element_text(color = "white", face = "bold", size = 20)) +
          guides(colour = guide_legend(override.aes = list(size = 5, alpha = 1)))
      ...
      if (input$swft_EddyCo_sub_data_type_Li840 == "Flow Rate") {
        ...
        swft.plot <- ggplot(swft.data.out, aes(x = readout_time, y = readout_val_double)) +
          ...
          labs(
            title = paste0(swft.data.out$SiteID[1], ": Li840 MFC Flow Rate 2-minute point data"),
            x = "", y = "Flow (SLPM)",
            color = "Sensor"
          ) +
    ...
    if (input$swft_EddyCo_data_type == "L2130") {
      if (input$swft_EddyCo_sub_data_type_L2130 %in% c("Isotope - 2H", "Isotope - 18O")) {
        ...
        swft.plot <- ggplot(swft.data.out, aes(x = readout_time, y = readout_val_double, color = SampleLevel)) +
          ...
          theme(strip.text.x = element_text(size = 12), text = element_text(color = "white", face = "bold", size = 20)) +
          labs(
            x = "", y = "per mil", title = paste0(input$swft_EddyCo_site, " - ", input$swft_EddyCo_data_type, " ", input$swft_EddyCo_sub_data_type_L2130),
            subtitle = paste0(input$swft_EddyCo_date_range[1], " to ", input$swft_EddyCo_date_range[2])
          ) +
          guides(colour = guide_legend(override.aes = list(size = 5, alpha = 1)))
      }
      if (input$swft_EddyCo_sub_data_type_L2130 == "H2O") {
        ...
        swft.plot <- ggplot(swft.data.out, aes(x = readout_time, y = readout_val_double, color = SampleLevel)) +
          ...
          theme(strip.text.x = element_text(size = 12), text = element_text(color = "white", face = "bold", size = 20)) +
          labs(
            x = "", y = "Micromoles Per Mole", title = paste0(input$swft_EddyCo_site, " - ", input$swft_EddyCo_data_type, " ", input$swft_EddyCo_sub_data_type_L2130),
            subtitle = paste0(input$swft_EddyCo_date_range[1], " to ", input$swft_EddyCo_date_range[2])
          ) +
          guides(colour = guide_legend(override.aes = list(size = 5, alpha = 1)))
      }
    ...
    if (input$swft_EddyCo_data_type == "Li7200") {
      if (input$swft_EddyCo_sub_data_type_Li7200 == "CO2") {
        ...
        swft.plot <- ggplot(swft.data.out, aes(x = readout_time, y = readout_val_double)) +
          ...
          theme(strip.text.x = element_text(size = 12), axis.text.x = element_text(angle = 270), text = element_text(color = "white", face = "bold", size = 20)) +
          labs(
            x = "", y = "Concentration (ppm)", title = paste0(input$swft_EddyCo_site, " - ", input$swft_EddyCo_data_type, " ", input$swft_EddyCo_sub_data_type_Li7200),
            subtitle = paste0(input$swft_EddyCo_date_range[1], " to ", input$swft_EddyCo_date_range[2])
          ) +
          facet_wrap(~`Stream Name`)
      }
      ...
      if (input$swft_EddyCo_sub_data_type_Li7200 == "Flow") {
        ...
        swft.plot <- ggplot(swft.data.out, aes(x = readout_time, y = readout_val_double)) +
          ...
          theme(strip.text.x = element_text(size = 12), axis.text.x = element_text(angle = 270), text = element_text(color = "white", face = "bold", size = 20)) +
          labs(
            x = "", y = "", title = paste0(input$swft_EddyCo_site, " - ", input$swft_EddyCo_data_type, " ", input$swft_EddyCo_sub_data_type_Li7200),
            subtitle = paste0(input$swft_EddyCo_date_range[1], " to ", input$swft_EddyCo_date_range[2])
          ) +
          facet_wrap(~`Stream Name`)
      }
      ...
      if (input$swft_EddyCo_sub_data_type_Li7200 == "Diagnostic") {
        ...
        swft.plot <- ggplot(swft.data.out, aes(x = readout_time, y = as.integer(readout_val_double), color = Diagnostic)) +
          ...
          scale_x_datetime(breaks = scales::pretty_breaks(n = 10), date_labels = "%Y-%m-%d") +
          labs(
            title = paste0(swft.data.out$SiteID[1], ": Li7200 Diagnostic 2-minute point data"),
            x = "", y = "Diagnostic",
    ...
    if (input$swft_EddyCo_data_type == "CO2") {
      ...
      swft.plot <- ggplot(swft.data.out, aes(x = readout_time, y = readout_val_double, color = `Stream Name`)) +
        ...
        labs(
          title = paste0(swft.data.out$SiteID[1], ": CO2 2-minute point data"),
          x = "", y = "CO2 (ppm)",
          color = "Sensor"
        ) +
        theme(text = element_text(color = "white", face = "bold", size = 20)) +
        guides(colour = guide_legend(override.aes = list(size = 5, alpha = 1))) # Option to angle the facet grid y panel text
    }
    if (input$swft_EddyCo_data_type == "H2O") {
      ...
      swft.plot <- ggplot(swft.data.out, aes(x = readout_time, y = readout_val_double, color = `Stream Name`)) +
        ...
        # scale_color_manual(values = swft.co2.colors)+
        labs(
          title = paste0(swft.data.out$SiteID[1], ": H2O 2-minute point data"),
          x = "", y = "undetermined",
          color = "Sensor"
        ) +
        theme(text = element_text(color = "white", face = "bold", size = 20)) +
    ...
    if (input$swft_EddyCo_data_type == "HMP155") {
      if (input$swft_EddyCo_sub_data_type_HMP155 == "Relative Humidity") {
        ...
        swft.plot <- ggplot(swft.data.out, aes(x = readout_time, y = readout_val_double)) +
          ...
          theme(strip.text.x = element_text(size = 12), axis.text.x = element_text(angle = 270), text = element_text(color = "white", face = "bold", size = 20)) +
          labs(
            x = "", y = "%", title = paste0(input$swft_EddyCo_site, " - ", input$swft_EddyCo_data_type, " ", input$swft_EddyCo_sub_data_type_HMP155),
            subtitle = paste0(input$swft_EddyCo_date_range[1], " to ", input$swft_EddyCo_date_range[2])
          )
      }
      if (input$swft_EddyCo_sub_data_type_HMP155 == "Temperature") {
        ...
        swft.plot <- ggplot(swft.data.out, aes(x = readout_time, y = readout_val_double)) +
          ...
          theme(strip.text.x = element_text(size = 12), axis.text.x = element_text(angle = 270), text = element_text(color = "white", face = "bold", size = 20)) +
          labs(
            x = "", y = "Temperature (C)", title = paste0(input$swft_EddyCo_site, " - ", input$swft_EddyCo_data_type, " ", input$swft_EddyCo_sub_data_type_HMP155),
            subtitle = paste0(input$swft_EddyCo_date_range[1], " to ", input$swft_EddyCo_date_range[2])
          )
      }
      if (input$swft_EddyCo_sub_data_type_HMP155 == "Dew Point") {
    ...
    if (input$swft_EddyCo_data_type == "ecse.mfm") {
      ...
      swft.plot <- ggplot(swft.data.out, aes(x = timestamp, y = mean, color = `Stream Name`)) +
        ...
        scale_x_datetime(breaks = scales::pretty_breaks(n = 10), date_labels = "%Y-%m-%d") +
        labs(
          title = paste0(swft.data.out$SiteID[1], ": ECSE MFM 2-minute point data"),
          x = "", y = "Flow Rate (SLPM)",
    ...
    if (input$swft_EddyCo_data_type == "ecse.mfm.pressures") {
      ...
      swft.plot <- ggplot(swft.data.out, aes(x = timestamp, y = mean, color = ML)) +
        ...
        facet_grid(~Location) +
        labs(
          title = paste0(swft.data.out$SiteID[1], ": ECSE MFM Pressures 2-minute point data"),
    ...
    if (input$swft_EddyCo_data_type == "ecse.voltage") {
      ...
      swft.plot <- ggplot(swft.data.out, aes(x = aggTime, y = mean, color = `Stream Name`)) +
        ...
        scale_x_datetime(breaks = scales::pretty_breaks(n = 10), date_labels = "%Y-%m-%d") +
        labs(
          title = paste0(swft.data.out$SiteID[1], ": ECSE Pump Voltage 2-minute point data"),
          x = "", y = "Voltage",
          color = "Sensor"
        ) +
        theme(strip.text.x = element_text(size = 12), axis.text.x = element_text(angle = 270), text = element_text(color = "white", face = "bold", size = 20))
    ...
    if (input$swft_EddyCo_data_type == "ec.temps") {
      ...
      swft.plot <- ggplot(swft.data.out, aes(x = by30, y = mean, color = `Stream Name`)) +
        ...
        scale_x_datetime(breaks = scales::pretty_breaks(n = 10), date_labels = "%Y-%m-%d") +
        labs(
          title = paste0(swft.data.out$SiteID[1], ": Hut Temperature 2-minute point data"), subtitle = "Averaged hourly",
